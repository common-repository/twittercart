...

{
    ...
    echo require_once TC_TEMPLATES_PATH . 'myaccount_page.php';
...

{
    ...
    return $wpdb->get_var( "SELECT twitter_account FROM $table_name WHERE user_id = $user_id" );
...

{
    ...
    $wpdb->query( $wpdb->prepare(
                    ...
                    "DELETE FROM $table_name WHERE user_id = %d", $user_id
    ...
    if ( is_object( $woocommerce->cart ) ) {
        ...
        foreach ( $products as $product_id ) {
            ...
            if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) {
                ...
                if ( tc_product_is_active_duplicate( $product_id ) ) {
